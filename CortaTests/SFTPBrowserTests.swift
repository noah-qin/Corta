...
/// Answers in the model's terms (a listing, a transfer outcome) and
/// records what it was asked. Transfer behaviour is scripted through
/// `onTransfer`; without one, a transfer reports progress and completes.
private final class FakeSFTPClient: SFTPClient, @unchecked Sendable {
    struct TransferCall {
        var isUpload: Bool
